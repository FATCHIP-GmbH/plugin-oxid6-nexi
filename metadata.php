...
$aModule = [
    ...
    'title' => [
        'de' => 'Nexi Payment Connector',
        'en' => 'Nexi Payment Connector',
    ],
    'description' => [
        'de' => '<p><b>Über Nexi</b><br><br>TODO: Add Nexi text here</p>
                ...
                <p><b>Nutzung von Nexi Payments</b><br><br>Um Nexi Payments über das Plugin zu nutzen, benötigen Sie einen Vertrag mit Nexi. Bitte kontaktieren Sie hierfür den Nexi Vertrieb unter ADD LINK HERE. Falls Sie bereits Kunde sind, bitten wir Sie, sich direkt an Ihren Account Manager zu wenden. Im Anschluss erhalten Sie Ihre Zugangsdaten mit denen Sie das Plugin in Betrieb nehmen können.</p>
                <p><b>Support</b><br><br>Persönlicher Support via E-Mail an <a href="mailto:serviceDE@nexigroup.com">serviceDE@nexigroup.com</a></p>',
        'en' => '<p><b>About Nexi</b><br><br>TODO: Add Nexi text here</p>
                ...
                <p><b>Using Nexi Payments</b><br><br>To use Nexi Payments via the plugin, you need a contract with Nexi. Please contact the Nexi sales department at ADD LINK HERE. If you are already a customer, please contact your account manager directly. You will then receive your access data with which you can put the plugin into operation.</p>
                <p><b>Support</b><br><br>Personal support via e-mail to <a href="mailto:serviceDE@nexigroup.com">serviceDE@nexigroup.com</a></p>',
    ],
