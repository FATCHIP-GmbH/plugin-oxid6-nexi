...
$aLang = [
    ...
    'HELP_SHOP_MODULE_creditCardTemplate'                   => 'Name of the XSLT-file with your individual payment form layout. If you want to use the responsive Nexi template for mobile devices, please use the template name „nexi_cards_v2“.',

    'HELP_SHOP_MODULE_paypalCaption'                        => '<p>Determines whether the requested amount is collected immediately or at a later date. <br><b>Important:<br>Please contact Nexi Support for Manual to clarify the different application options.</b></p>',

    'HELP_SHOP_MODULE_paypalExpressTestMode'                => 'Test Modus',
    'HELP_SHOP_MODULE_paypalExpressCaption'                 => 'Bestimmt, ob der angefragte Betrag sofort oder erst später eingezogen wird. <br><b>Wichtig:<br>Bitte kontaktieren Sie den Nexi Support für Manual, um die unterschiedlichen Einsatzmöglichkeiten abzuklären.</b>',
    ...
    'HELP_SHOP_MODULE_paypalExpressPartnerAttributionID'    => 'Nexi Partner-Attribution-ID.',
    ...
    'FATCHIP_COMPUTOP_PAYMENT'          => 'Nexi Zahlarten Einstellungen',
    'fatchip-computop-payments'        => 'Nexi',
    ...
    'FATCHIP_COMPUTOP_REMARK' => 'Nexi Mitteilung',
    ...
    'FATCHIP_COMPUTOP_NO_COMPUTOP_PAYMENT' => 'Keine Nexi Bestellung',
    'FATCHIP_COMPUTOP_HEADER_SINGLE_PRICE' => 'Einzelpreis',
    'FATCHIP_COMPUTOP_CAPTURE_SUBMIT' => 'Beitrag einziehen',
    'FATCHIP_COMPUTOP_ORDER_SETTINGS' => 'Nexi',
    'FATCHIP_COMPUTOP_PAYMENT_DETAILS' => 'Nexi Bestelldetails',
